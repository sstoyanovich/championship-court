...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('user_cards', function (Blueprint $table) {
            ...
            $table->integer('total_fgm')->default(0); // Field goals made
            $table->integer('total_fga')->default(0); // Field goals attempted

            // Three pointers (made/attempted)
            $table->integer('total_3pm')->default(0); // 3-pointers made
            $table->integer('total_3pa')->default(0); // 3-pointers attempted
        });
    }
